...
class FtxClient:
    ...
    def transfer_fundings(self, coin: str, size: float, source: str, destination: str):
    ...
    def place_order(self, market: object, side: object, price: object, size: object, type: object = 'limit',
                    reduce_only: object = False, ioc: object = False, post_only: object = False,
                    client_id: object = None) -> object:
    ...
    def get_fills(self, start_time, end_time, market) -> List[dict]:
        return self._get(f'fills', {'start_time': start_time, 'end_time':end_time, 'market':market})

    def get_balances(self) -> List[dict]:
        return self._get('wallet/balances')

    # deze heeft Sam gemaakt !!
    # def get_sub_balances(self, subaccount) -> List[dict]:
